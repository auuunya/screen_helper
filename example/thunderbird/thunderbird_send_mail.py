...
def send_mail():
    ...
    screen.record_screen_snapshot(screen_desktop_window, f"{template_dir}/desktop_window.png")
    ...
    screen.record_screen_snapshot(screen_thunderbird_window, f"{template_dir}/thunderbird_window.png")
    ...
    screen.record_screen_snapshot(thunderbird_write_mail_window, f"{template_dir}/thunderbird_write_mail_window.png")
    ...
    screen.record_screen_snapshot(send_mail_screenshot, f"{template_dir}/send_mail_screen.png")
